...
import numpy as np
# 定义保存模型的文件夹路径
checkpoint_dir = "/home/user/data/gsj/model/22/BaseModel_mdd200_dfc_time/"
# 创建一个文件夹用于保存模型
...
def main():
    ...
    parser.add_argument('--dataroot', type=str, default='/home/user/data/gsj/data/mdd/200/timeseries_200', help='root directory of the dataset')
    parser.add_argument('--fold', type=int, default=10, help='training which fold')
    parser.add_argument('--lr', type=float, default=0.0001, help='learning rate')
    parser.add_argument('--weightdecay', type=float, default=0.001, help='regularization')
    ...
    for fold in range(0, fold):
        ...
        model = TransformerModel(input_dim=200, num_classes=2).to(device)  # input 200 25
    ...
    #######################################################################################
        ...
        # 定义保存模型的文件夹路径
        checkpoint_dir = "/home/user/data/gsj/model/22/BaseModel_mdd200_dfc_time/"
        best_model_dir = "/home/user/data/gsj/model/22/Bset_BaseModel_mdd200_dfc_time/"
        best_model_path = ""
        test_accuracy1 = 0
        test_ave = 0

...
from imports.cnn_Dataset import stage2_abide2_Dataset_official
...
def main():
    ...
    def test(loader, prefix):
        i = 0
        checkpoint = torch.load('/home/user/data/gsj/model/Bset_BaseModel_dfc/checkpoint_fold0+epoch_5.pth')
        ...
        with torch.no_grad():
            for datas in loader:
                ...
                if pred == 0:
                    ...
                    folder_path1 = os.path.join('/home/user/data/gsj/data/abide2/60_3mdd-abide1-afterstage2',
                                                prefix, '0')
                    ...
                    suffix = i  # 假设你的数据中有一个名为 suffix 的字段来表示后缀
                    folder_path2 = os.path.join('/home/user/data/gsj/data/abide2/60_3mdd-abide1-afterstage2',
                                                prefix, '1')
    ...
    target_root = '/home/user/data/gsj/data/abide2/60_3'
    ...
    for prefix in prefix_folders:
        ...
        dataset = stage2_abide2_Dataset_official(path, save_dir=path)

...
def main():
        ...
        with torch.no_grad():
            for datas in loader:
                ...
                if pred == 0:
                    ...
                    folder_path1 = os.path.join('/home/user/data/gsj/data/abide1/116/60_3mdd-abide1-timeafterstage2',
                                                prefix, '0')
                    ...
                    suffix = i  # 假设你的数据中有一个名为 suffix 的字段来表示后缀
                    folder_path2 = os.path.join('/home/user/data/gsj/data/abide1/116/60_3mdd-abide1-timeafterstage2',
                                                prefix, '1')
    ...
    target_root = '/home/user/data/gsj/data/abide1/116/60_3_time'

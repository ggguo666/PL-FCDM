...
#
#         output_dir1 = os.path.join('/home/caorui/g/data/abide_116/2/dfcave', d1)
#         os.makedirs(output_dir1, exist_ok=True)  # 确保文件夹存在
#
#
#         len_path = os.path.join("/home/caorui/g/data/abide_116/dfc/",d1)
#
...
# def main():
#     # 假设保存特征文件的文件夹路径
#     folder_path = '/home/caorui/g/data/abide_116/2/common_files_dfc'
#
#     # 计算平均特征值
...
def compute_average_feature(folder_path):
    ...
    for d1 in dirs:
        ...
        output_dir1 = os.path.join('/home/user/data/gsj/data/abide2/60_3_ave', d1)
        os.makedirs(output_dir1, exist_ok=True)  # 确保文件夹存在
        ...
        if max_files == 0:
            print(d1)
            new_path1 = os.path.join("/home/user/data/gsj/data/abide2/60_3mdd-abide1-afterstage2/", d1)
            # 存储每个子文件夹的文件数量和路径
            folder_file_count = []
...
def main():
    # 假设保存特征文件的文件夹路径
    folder_path = '/home/user/data/gsj/data/abide2/60_3common_files_dfc'
...
#         path1 = os.path.join(folder_path, d1)
#
#         output_dir1 = os.path.join('/home/user/data/gsj/data/mdd/200/dfcave', d1)
#         os.makedirs(output_dir1, exist_ok=True)  # 确保文件夹存在
#
#         # 存储每个子文件夹的文件数量和路径
#         folder_file_count = []
...
#         if max_files == 0:
#             print(d1)
#             new_path1 = os.path.join("/home/user/data/gsj/data/mdd/200/abide1-mdd-afterstage2/", d1)
#             # 存储每个子文件夹的文件数量和路径
#             folder_file_count = []
#
#             # 遍历该文件夹下的子文件夹，统计文件数量
...
# def main():
#     # 假设保存特征文件的文件夹路径
#     folder_path = '/home/user/data/gsj/data/mdd/200/common_files_dfc'
#
#     # 计算平均特征值
#     compute_average_feature(folder_path)
#
...
#         path1 = os.path.join(folder_path, d1)
#
#         output_dir1 = os.path.join('/home/caorui/g/data/abide_116/2/time+cluster+ave', d1)
#         os.makedirs(output_dir1, exist_ok=True)  # 确保文件夹存在
#
#         # 存储每个子文件夹的文件数量和路径
#         folder_file_count = []
...
#         if max_files == 0:
#             print(d1)
#             new_path1 = os.path.join("/home/caorui/g/data/abide_116/2/dfc_time/mdd-abide1-58afterstage2/", d1)
#             # 存储每个子文件夹的文件数量和路径
#             folder_file_count = []
#
#             # 遍历该文件夹下的子文件夹，统计文件数量
...
# def main():
#     # 假设保存特征文件的文件夹路径
#     folder_path = '/home/caorui/g/data/abide_116/2/common_files_time+cluster'
#
#     # 计算平均特征值
#     compute_average_feature(folder_path)
#

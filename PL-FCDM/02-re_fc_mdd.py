...
def compute_average_feature(folder_path):
    ...
    for d1 in dirs:
        ...
        output_dir1 = os.path.join('/home/user/data/gsj/data/mdd/116/60_3_ave', d1)
        ...
        if max_files == 0:
            print(d1)
            new_path1 = os.path.join("/home/user/data/gsj/data/mdd/116/60_3abide1-mdd-afterstage2/", d1)
            # 存储每个子文件夹的文件数量和路径
            folder_file_count = []
...
def main():
    # 假设保存特征文件的文件夹路径
    folder_path = '/home/user/data/gsj/data/mdd/116/60_3common_files_dfc'

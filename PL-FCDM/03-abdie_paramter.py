...
'''
        超参数调优
        nnictl create --config /home/caorui/g/my_model/251/guo_2/config.yaml -p 8082
...
def main():
    ...
    parser.add_argument('--dataroot', type=str, default='/home/caorui/g/data/abide_116/2/22222cluster/dfcave',

...
'''
        超参数调优
        nnictl create --config /home/caorui/g/my_model/251/guo_2/adhd_config.yaml -p 8888
        nnictl create --config config_windows.yml -p 8080
        ssh -p 22 -L 8888:127.0.0.1:8888 caorui@183.175.136.251
        ssh -p 2023 -L 8080:127.0.0.1:8080 user@183.175.136.250
'''
...
def main():
    ...
    params = {'batchSize': 64,
              'lr1': 0.0002,'weightdecay1': 0.0001,
              'lr': 0.005, 'weightdecay': 0.00007,
              'stepsize': 50, 'gamma': 0.8,
              'dropout_rate': 0.1,
              }
    ...
    parser.add_argument('--dataroot', type=str, default='/home/caorui/g/data/adhd200_116/2/dfcave',
